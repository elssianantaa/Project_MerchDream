...
<div style="background-color: white;">
    <div class="container pt-5">
        <div class="row">
            <div class="col-md-6">
                <button class="" style="border: none;text-decoration: none;border-radius: 15px;background: linear-gradient(to right, #c8bad8, #746991);width: 380px;height: 40px;font-size: 20px;font-weight: bold;font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;">
                   SHOP<!-- Nama Kategori -->
                </button>
            </div>
            <div class="col-md-6">
